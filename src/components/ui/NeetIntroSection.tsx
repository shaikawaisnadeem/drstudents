...
export default function NeetIntroSection() {
  return (
    <section className="max-w-7xl mx-auto px-6 py-14 font-poppins">
      ...
      <p className="text-lg leading-relaxed text-gray-700 max-w-4xl mb-10 underline-offset-2 decoration-gray-400 underline">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-[#B7F7C1] p-6 rounded-xl flex flex-col relative shadow-md">
  <div className="flex items-center justify-between">
